...
| `test_core.tcyr` | unit tests | mode manager, permissions, intent parsing, translators, approval matrix, audit log, security context (301 checks) |
...
| `test.sh` | runner | builds the shell, then runs core → security → smoke → bench |
